...
export const blogPosts: BlogPost[] = [
  {
    id: '1',
    slug: 'early-signs-breast-cancer-women-should-know',
    title: '7 Early Warning Signs of Breast Cancer Every Woman Should Know',
    excerpt:
      'Detecting breast cancer early dramatically improves treatment outcomes. Learn the key warning signs and when to seek medical evaluation.',
    category: 'Breast Cancer',
    date: '2024-08-15',
    readTime: '6 min read',
    author: 'Dr. Nitya Nutan Misra',
    tags: ['breast cancer', 'early detection', 'women health', 'cancer awareness'],
    content: `Breast cancer is one of the most prevalent cancers among women globally, and in India it accounts for nearly 14% of all female cancers. The encouraging truth is that when detected early — at Stage I or II — the 5-year survival rate exceeds 90%. This is why awareness of early warning signs is life-saving knowledge.
...
At AHPGIC, Dr. Nitya Nutan Misra andhisteam offer prompt evaluation, imaging, and biopsy services to ensure timely diagnosis and treatment planning.`,
  ...
  {
    id: '2',
    slug: 'understanding-thyroid-cancer-treatment-options',
    title: 'Understanding Thyroid Cancer: Types, Diagnosis & Modern Treatment',
    excerpt:
      'Most thyroid cancers are highly treatable. This guide explains the different types, how they are diagnosed, and the surgical options available.',
    category: 'Thyroid Cancer',
    date: '2024-07-20',
    readTime: '7 min read',
    author: 'Dr. Nitya Nutan Misra',
    tags: ['thyroid cancer', 'thyroidectomy', 'endocrine tumors', 'cancer surgery'],
    content: `Thyroid cancer is among the most common endocrine malignancies and, importantly, one of the most curable cancers when treated appropriately. Understanding the disease helps patients make informed decisions about their care.
...
Most thyroid cancers are highly curable. Do not delay — consult a surgical oncologist if you have a thyroid nodule or swelling in the neck.`,
  ...
  {
    id: '3',
    slug: 'head-neck-cancer-warning-signs-risk-factors',
    title: 'Head & Neck Cancer: Warning Signs, Risk Factors & When to Act',
    excerpt:
      'Tobacco and alcohol are major risk factors for head and neck cancers. Recognise the warning signs and seek expert evaluation early.',
    category: 'Head & Neck Cancer',
    date: '2024-06-10',
    readTime: '5 min read',
    author: 'Dr. Nitya Nutan Misra',
    tags: ['head neck cancer', 'oral cancer', 'laryngeal cancer', 'cancer prevention'],
    content: `Head and neck cancers — including cancers of the mouth, throat, voice box, nose, and salivary glands — represent a significant proportion of cancers in India, largely attributable to widespread tobacco and betel nut use.
...
Early-stage head and neck cancers are frequently curable with surgery alone or surgery plus radiation. Stage IV disease requires multimodality treatment and is far more challenging — which is why early presentation is critical.`,
  ...
  {
    id: '4',
    slug: 'what-to-expect-cancer-surgery-guide',
    title: 'What to Expect Before, During & After Cancer Surgery: A Patient Guide',
    excerpt:
    ...
    readTime: '8 min read',
    author: 'Dr. Nitya Nutan Misra',
    tags: ['cancer surgery guide', 'patient information', 'surgical oncology', 'recovery'],
    content: `Being told you need cancer surgery brings fear and uncertainty. Understanding what to expect can significantly reduce anxiety and help you recover better.
